...
var toTwelve = require('twentyfour-to-twelve');
var toTwentyFour = require('twelve-to-twentyfour');
var vue = require('vue');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var addZero__default = /*#__PURE__*/_interopDefaultLegacy(addZero);
var toTwelve__default = /*#__PURE__*/_interopDefaultLegacy(toTwelve);
var toTwentyFour__default = /*#__PURE__*/_interopDefaultLegacy(toTwentyFour);
...
const timeTextToNumber = (timeText, isTwelfthMode) => {
  ...
  if (isTwelfthMode) {
    parsedTime = toTwentyFour__default["default"](timeText);
  }
...
const timeNumberToText = (timeNumber, isTwelfthMode) => {
  ...
  const twentyFourText = addZero__default["default"](hours) + ':' + addZero__default["default"](minutes);
  if (isTwelfthMode) {
    return toTwelve__default["default"](twentyFourText);
  }
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    vue.createCommentVNode(" scales "),
    vue.createElementVNode("g", null, [
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.ranges, (range) => {
        return (vue.openBlock(), vue.createElementBlock("g", {
          key: range.name,
          id: range.name
        }, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(range.arcs, (arc) => {
            return (vue.openBlock(), vue.createElementBlock("path", {
              key: arc.name,
              id: range.name,
              style: vue.normalizeStyle({stroke: range.scaleColor}),
              d: `
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("g", _hoisted_1$3, [
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.marks, (mark) => {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("g", _hoisted_1$2, [
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.quarterTexts, (quarterText) => {
      return (vue.openBlock(), vue.createElementBlock("text", {
        ...
        vue.createElementVNode("tspan", null, vue.toDisplayString(quarterText.name), 1 /* TEXT */)
      ], 4 /* STYLE */))
    }), 128 /* KEYED_FRAGMENT */))
  ]))
}
...
const _withScopeId = n => (vue.pushScopeId("data-v-3ca499ed"),n=n(),vue.popScopeId(),n);
const _hoisted_1$1 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/vue.createElementVNode("filter", {
  id: "dropshadow",
  height: "130%"
}, [
  ...
  /*#__PURE__*/vue.createCommentVNode(" stdDeviation is how much to blur "),
  /*#__PURE__*/vue.createElementVNode("feOffset", {
    dx: "0",
    dy: "0",
    result: "offsetblur"
  }),
  /*#__PURE__*/vue.createCommentVNode(" how much to offset "),
  /*#__PURE__*/vue.createElementVNode("feComponentTransfer", null, [
    /*#__PURE__*/vue.createElementVNode("feFuncA", {
      type: "linear",
      slope: "0.35"
    }),
    /*#__PURE__*/vue.createCommentVNode(" slope is the opacity of the shadow ")
  ]),
  /*#__PURE__*/vue.createElementVNode("feMerge", null, [
    /*#__PURE__*/vue.createElementVNode("feMergeNode"),
    /*#__PURE__*/vue.createCommentVNode(" this contains the offset blurred image "),
    /*#__PURE__*/vue.createElementVNode("feMergeNode", { in: "SourceGraphic" }),
    /*#__PURE__*/vue.createCommentVNode(" this contains the element that the filter is applied to ")
  ])
], -1 /* HOISTED */));
  ...
  return (vue.openBlock(), vue.createElementBlock("g", {
    ...
    vue.createElementVNode("g", null, [
      (_ctx.isShowChosenTime)
        ? (vue.openBlock(), vue.createElementBlock("g", _hoisted_2$1, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.movePointers, (pointer) => {
              return (vue.openBlock(), vue.createElementBlock("g", {
            ...
            'transform-origin': '-7.8% -0.5%',
              ...
              fill: _ctx.chosenTimeColor
                  ...
                  class: "chosen-time"
                }, vue.toDisplayString(_ctx.timeNumberToText(pointer.time, _ctx.isTwelfthMode)), 13 /* TEXT, STYLE, PROPS */, _hoisted_3$1)
              ], 4 /* STYLE */))
            }), 128 /* KEYED_FRAGMENT */))
          ]))
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_RangesScales = vue.resolveComponent("RangesScales");
  const _component_HoursMarks = vue.resolveComponent("HoursMarks");
  const _component_QuartersTexts = vue.resolveComponent("QuartersTexts");
  const _component_ChosenTimePointers = vue.resolveComponent("ChosenTimePointers");
  ...
  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
    (vue.openBlock(), vue.createElementBlock("svg", {
      ...
      vue.createCommentVNode(" group with set of svg-paths drawing arcs "),
      vue.createVNode(_component_RangesScales, {
        ranges: _ctx.ranges,
        circleStrokeWidth: _ctx.combinedViewOptions.circleStrokeWidth
      }, null, 8 /* PROPS */, ["ranges", "circleStrokeWidth"]),
      vue.createCommentVNode(" hours marks around circle "),
      (_ctx.combinedViewOptions.isShowHoursMarks)
        ? (vue.openBlock(), vue.createBlock(_component_HoursMarks, {
            key: 0,
            hoursMarksColor: _ctx.combinedViewOptions.hoursMarksColor
          }, null, 8 /* PROPS */, ["hoursMarksColor"]))
        : vue.createCommentVNode("v-if", true),
      vue.createCommentVNode(" quarter hours labels inside circle "),
      (_ctx.combinedViewOptions.isShowQuartersText)
        ? (vue.openBlock(), vue.createBlock(_component_QuartersTexts, {
            key: 1,
        ...
        : vue.createCommentVNode("v-if", true),
      vue.createCommentVNode(" buttons on circle to change ranges "),
      vue.createVNode(_component_ChosenTimePointers, {
        isTwelfthMode: _ctx.isTwelfthMode,
      ...
      vue.createCommentVNode(" invisible element for moving angle detecting "),
